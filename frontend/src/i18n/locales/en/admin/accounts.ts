export default {
    accounts: {
      ...
      openai: {
        ...
        excelBPSMihomo: 'Pin BPS sessions to Mihomo exits',
        excelBPSMihomoDesc: 'Disabled by default. Configure and start the Mihomo proxy pool in system settings first. Keep each identified session on one proxy node; distribute new sessions by load. Unavailable nodes fail closed without switching exits. Idle bindings expire after 30 minutes and reset on service restart. Dynamic IP providers must support sticky exits. Turning this off restores the account proxy.',
